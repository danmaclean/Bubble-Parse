...
MAKE = make
FULLEXT = Bubble/Parse
BASEEXT = Parse
PARENT_NAME = Bubble
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Bubble/Parse.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
INST_LIBDIR      = $(INST_LIB)/Bubble
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Bubble
...
DISTNAME = Bubble-Parse
DISTVNAME = Bubble-Parse-0.01
